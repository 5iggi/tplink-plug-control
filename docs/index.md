<p align="center">
  <img src="../icons/icon.svg" alt="TP-Link Plug Control Logo" width="256" height="256">
</p>

<h1 align="center">TP-Link Plug Control Documentation</h1>
<p align="center">
...
Bitte Sprache auswählen / Please select a language:

## Deutsch

- [Übersicht](de/README.md)
- [Installation](de/installation.md)
- [Loxone Integration](de/loxone.md)
- [HTTP API](de/api.md)
...
- [Loxone integration](en/loxone.md)
- [HTTP API](en/api.md)
